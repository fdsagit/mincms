 ...
 */
class AlipayController extends \app\core\FrontController
{ 
 	public $return_url;
 	public $notify_url;
	function init(){
        ...
        $files = array(
        	base_path().'modules/payment/libraries/alipay/alipay_core.function.php',
        	base_path().'modules/payment/libraries/alipay/alipay_md5.function.php',
        	base_path().'modules/payment/libraries/alipay/alipay_notify.class.php',
        	base_path().'modules/payment/libraries/alipay/alipay_submit.class.php',
        );
        Load::file($files);
